...
public:
	...
	[[nodiscard]] unsigned get_healing_value() const { return healing_value_; }
	[[nodiscard]] unsigned get_hurting_value() const { return hurting_value_; }
	[[nodiscard]] unsigned get_armor_value() const { return armor_value_; }
