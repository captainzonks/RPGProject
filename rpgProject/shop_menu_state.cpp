...
void shop_menu_state::handle_events(game* game)
{
	...
	//			{
	//				game->player->access_currency().subtract_money(helmet_ptr->GetValue());
	//				game->player->access_inventory().equip(std::move(helmet_ptr));
	//				std::cout << "Obtained a Helmet!" << std::endl;
	//				break;
	//			}
	//			else
	//			{
